...
function GamePage() {
    ...
    //DECLARE COBA BERUBAH BACKGROUND
    const [data, setData] = useState({});
    const [location, setLocation]= useState("");
    const url = `https://api.jsonbin.io/b/628f93f505f31f68b3a87019`

    //buat fungsi yang dapat mengambil data backgroundImage dari link https://api.jsonbin.io/b/628f93f505f31f68b3a87019 berdasarkan location
                ...
                <div className="body">
                    ...
                    <div className="activity-button-group">
                        <ButtonGroup spacing='6'>
                            <Button id='tombolSleep'>Sleep</Button>
                            <Button id='tombolEat'>Eat</Button>
                            <Button id='tombolDiscord'>Discord</Button>
                            <Button id='tombolBelajar'>Belajar</Button>
                            <Button id='tombolMain'>Main</Button>
                        </ButtonGroup>
                        <ButtonGroup spacing='6'>
                            <Button>Home</Button>
